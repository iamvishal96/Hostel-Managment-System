...
class DeatailsRoom:
    def __init__(self,root):
        ...
        lblimg.place(x=0,y=0,width=120,height=50)
 
        #========================labelframe============================
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="ROOM DETAILS",font=("arial",12,"bold"))
...
#add data
    ...
    def mDelete(self):
       mDelete=messagebox.askyesno("Hostel Management System","Do you want delete this Room details",parent=self.root)
       if mDelete>0:
            conn=mysql.connector.connect (host="localhost", username="root", password="Vishal@123", database="student")
            my_cursor=conn.cursor()
